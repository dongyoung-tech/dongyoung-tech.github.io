...
var mbti3=""
 ...
 var foodname= {
        ...
        /*==============한식 메뉴===================*/
        "CSS":{1:"탕후루",2:"탕수육",3:"딤섬"},
        "CTS":{1:"딤섬",2:"탕수육",3:"탕후루"},
        "CSM":{1:"자장면",2:"동파육",3:"짬뽕",4:"탕수육",5:"훠궈",6:"마라탕",7:"양꼬치"},
        "CTM":{1:"훠궈",2:"마라탕",3:"마라롱샤",4:"양꼬치",5:"자장면",6:"짬뽕",7:"동파육"},
        /*=========중식메뉴==================*/
        "JSS":{1:"당고",2:"오코노미야끼",3:"타코야끼",4:"라멘",5:"우동",6:""},
        "JTS":{1:"당고",2:"오코노미야끼",3:"타코야끼"},
        "JSM":{1:"덮밥",2:"돈가스",3:"라멘",4:"초밥",5:"우동",6:"카츠동",7:"소바"},
        "JTM":{1:"초밥",2:"돈가스",3:"스키야키",4:"라멘",5:"카츠동",6:"소바",7:"규동"},
        /*===============일식메뉴 =============*/
        "WSS":{1:"햄버거",2:"핫도그",3:"도넛"},
        "WTS":{1:"햄버거",2:"파이",3:"샌드위치"},
        "WSM":{1:"햄버거",2:"스테이크",3:"버팔로윙"},
        "WTM":{1:"치킨",2:"스테이크",3:"피자"}
       }
